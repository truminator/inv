...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { location_id: @inventory.location_id, make: @inventory.make, serial: @inventory.serial, type: @inventory.type }
    end
  ...
  test "should update inventory" do
    put :update, id: @inventory, inventory: { location_id: @inventory.location_id, make: @inventory.make, serial: @inventory.serial, type: @inventory.type }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
